...
#define ALIEN_MAX_CREDITS        4000 // CREDITS_PER_EVO converts this to evos for display
#define ALIEN_TK_SUICIDE_PENALTY 2000
...
#define HUMAN_MAX_CREDITS             1000
#define HUMAN_TK_SUICIDE_PENALTY      250
